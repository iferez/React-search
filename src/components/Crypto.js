...
const Crypto = () => {
  ...
  return (
    <>
    <h3 className='mt-5'> Search now !</h3>
    <input value={search} onChange={searcher} type='text' placeholder='Type name...' className='form-control' />
        ...
        <tbody>
            { results.map( (result)=> (
                <tr key={result.id}>
                    ...
                    <td><small><img src={result.image.small} className='pe-3'/> {result.name} </small></td>
